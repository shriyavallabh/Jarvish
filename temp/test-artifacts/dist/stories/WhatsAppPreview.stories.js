...
exports.NoDisclaimer = exports.LongMessage = exports.WithDocument = exports.HindiContent = exports.ProTierBranding = exports.WithImage = exports.TextMessage = void 0;
const WhatsAppPreview_1 = require("../apps/web/components/WhatsAppPreview");
const meta = {
    title: 'Components/WhatsAppPreview',
    component: WhatsAppPreview_1.WhatsAppPreview,
    parameters: {
        layout: 'centered',
        docs: {
            description: {
