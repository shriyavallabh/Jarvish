...
export const accessibility = {
  ...
  focus: {
    ...
    shadow: `0 0 0 2px ${colors.brand.primary}`,
...
export const financial = {
  ...
  complianceColors: {
    excellent: colors.compliance.compliant,    // 90-100
    good: colors.compliance.riskLow,          // 75-89
    acceptable: colors.compliance.riskMedium,  // 60-74
    concerning: colors.compliance.riskHigh,    // 40-59
    critical: colors.compliance.riskCritical,  // 0-39
  },

  // Risk level indicators
  riskLevels: {
    low: { color: colors.compliance.riskLow, background: '#ECFDF5' },
    medium: { color: colors.compliance.riskMedium, background: '#FFFBEB' },
    high: { color: colors.compliance.riskHigh, background: '#FEF2F2' },
    critical: { color: colors.compliance.riskCritical, background: '#FEF2F2' },
  },
  ...
  contentStatus: {
    draft: { color: colors.status.draft, background: '#F9FAFB' },
    pending: { color: colors.status.pending, background: '#FEF3C7' },
    approved: { color: colors.status.delivered, background: '#ECFDF5' },
    rejected: { color: colors.status.failed, background: '#FEF2F2' },
    scheduled: { color: colors.status.scheduled, background: '#EFF6FF' },
    delivered: { color: colors.status.delivered, background: '#ECFDF5' },
  },

  // Data visualization for financial metrics
  metrics: {
    positive: colors.charts.positive,
    negative: colors.charts.negative,
    neutral: colors.charts.neutral,
    benchmark: colors.charts.benchmark,
    prediction: colors.charts.prediction,
  },
} as const;
...
export const components = {
  ...
  button: {
    ...
    transition: animation.components.button,
    sizes: sizes.button,
    shadows: shadows.button,
  },
  ...
  input: {
    borderRadius: borderRadius.md,
    border: `1px solid ${colors.semantic.border}`,
    focusBorder: `1px solid ${colors.brand.primary}`,
    shadow: shadows.sm,
    focusShadow: shadows.card.focus,
    sizes: sizes.input,
  },
  ...
  modal: {
    ...
    shadow: shadows.xl,
    overlay: colors.backgrounds.overlay,
    background: colors.backgrounds.default,
    padding: spacing.component.cardPadding,
  },
  ...
  navigation: {
    height: spacing.component.headerHeight,
